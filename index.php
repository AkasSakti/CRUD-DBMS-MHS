...
<body>
  ...
  <section class="row">
    <div class="col-md-6 offset-md-3 align-self-center"> 
      <h1 class="text-center">Daftar Mahasiswa Fakultas Vokasi-UNIVERSITAS BRAWIJAYA</h1>
      <h1 class="text-center">D-III Teknologi Informasi</h1>
